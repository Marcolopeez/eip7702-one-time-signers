...
contract EphemeralKeyAccount7702Test is Test {
    ...
    EphemeralKeyAccount internal implementation;
    ...
    function setUp() public {
        ...
        implementation = new EphemeralKeyAccount();
        target = new ExecutionTarget();

        vm.label(A1, "A1 - delegated EOA");
        vm.label(A2, "A2 - first ephemeral signer");
        vm.label(A3, "A3 - second ephemeral signer");
        vm.label(A4, "A4 - third ephemeral signer");
        ...
        vm.label(address(implementation), "EphemeralKeyAccount implementation");
    ...
    function test_initialize_revertsWhenCalledOnImplementation() public {
        ...
        vm.expectRevert(EphemeralKeyAccount.MustBeCalledThroughDelegation.selector);
    ...
    function test_initialize_revertsWithZeroAuthorizedSigner() public {
        ...
        vm.prank(A1);
        vm.expectRevert(EphemeralKeyAccount.InvalidNextAuthorizedSigner.selector);
    ...
    function test_initialize_revertsWhenCallerIsNotDelegatedAccount() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                EphemeralKeyAccount.UnauthorizedInitializer.selector,
                attacker,
                A1
            )
        );
    ...
    function test_initialize_revertsWhenCalledTwice() public {
        ...
        vm.prank(A1);
        vm.expectRevert(EphemeralKeyAccount.AlreadyInitialized.selector);
    ...
    function test_initialize_revertsWithZeroRecoverySigner() public {
        ...
        vm.prank(A1);
        vm.expectRevert(EphemeralKeyAccount.InvalidNewRecoverySigner.selector);
    ...
    function test_rotateAuthorizedSigner_revertsWhenCallerIsDelegatedAccountItself() public {
        ...
        vm.prank(A1);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.Unauthorized.selector, A1, A2));
    ...
    function test_rotateAuthorizedSigner_burnsPreviousSigner() public {
        ...
        vm.prank(A2);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.Unauthorized.selector, A2, A3));
    ...
    function test_rotateAuthorizedSigner_pausesWithZeroNextAuthorizedSigner() public {
        ...
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.InvalidNextAuthorizedSigner.selector));
    ...
    function test_rotateAuthorizedSigner_pausesWhenReusingDelegatedAccountAddress() public {
        ...
        assertFalse(success, "invalid rotation should be reported as failed");
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.SignerAlreadyConsumedOrReserved.selector, A1));
    ...
    function test_rotateAuthorizedSigner_pausesWhenReusingPreviousAuthorizedSigner() public {
        ...
        assertFalse(success, "invalid rotation should be reported as failed");
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.SignerAlreadyConsumedOrReserved.selector, A2));
    ...
    function test_executeSignedAndRotate_allowsRelayerToSubmitOperationSignedByA2() public {
        ...
        EphemeralKeyAccount.Operation memory operation = _operation({
    ...
    function test_executeSignedAndRotate_allowsNewKeyToContinueChain() public {
        ...
        EphemeralKeyAccount.Operation memory firstOperation = _operation({
            target_: address(target),
            value_: 0,
            data_: abi.encodeCall(ExecutionTarget.setNumber, (42)),
            nextAuthorizedSigner_: A3
        ...
        EphemeralKeyAccount.Operation memory secondOperation = _operation({
            target_: address(target),
            value_: 0,
    ...
    // -------------------------------------------------------------------------
    // Signed execution: ephemeral-signer security property
    // -------------------------------------------------------------------------
    ...
    function test_executeSignedAndRotate_burnsA2SignatureAfterFailedExecution() public {
        ...
        vm.prank(relayer);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.InvalidSignature.selector, A2, A3));
    ...
    function test_executeSignedAndRotate_revertsWithInvalidSigner() public {
        ...
        vm.prank(relayer);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.InvalidSignature.selector, attacker, A2));
        _account(A1).executeSignedAndRotate(operation, signature);
    ...
    function test_executeSignedAndRotate_pausesWhenReusingAuthorizedSigner() public {
        ...
        EphemeralKeyAccount.Operation memory op1 = _operation({
            target_: address(target),
            value_: 0,
        ...
        EphemeralKeyAccount.Operation memory op2 = _operation({
            target_: address(target),
            value_: 0,
    ...
    function test_executeSignedAndRotate_rotatesAndReturnsFailureWhenOperationExpired() public {
        ...
        EphemeralKeyAccount.Operation memory operation = EphemeralKeyAccount.Operation({
        ...
        assertEq(
            result,
            abi.encodeWithSelector(EphemeralKeyAccount.ExpiredOperation.selector, operation.deadline),
    ...
    function test_executeSignedAndRotate_rotatesAndReturnsFailureWithZeroTarget() public {
        ...
        assertEq(
            result,
            abi.encodeWithSelector(EphemeralKeyAccount.InvalidTarget.selector),
    ...
    function test_executeSignedAndRotate_rejectsSignatureBoundToAnotherDelegatedAccount() public {
        ...
        vm.prank(relayer);
        vm.expectRevert(
            abi.encodeWithSelector(EphemeralKeyAccount.InvalidSignature.selector, recoveredAgainstA1, A2)
        );
    ...
    function test_pausedAccount_revertsNormalSignedExecution() public {
        ...
        vm.prank(relayer);
        vm.expectRevert(EphemeralKeyAccount.AccountIsPaused.selector);
        _account(A1).executeSignedAndRotate(operation, signature);
    ...
    function test_rotateAuthorizedSignerThroughRecovery_revertsWhenCallerIsNotActiveRecoverySigner() public {
        ...
        vm.prank(attacker);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.RecoverySignerNotActive.selector, attacker));
    ...
    function test_rotateAuthorizedSignerThroughRecovery_cannotReuseConsumedRecoverySigner() public {
        ...
        vm.prank(R1);
        vm.expectRevert(abi.encodeWithSelector(EphemeralKeyAccount.RecoverySignerNotActive.selector, R1));
    ...
    function test_rotateAuthorizedSignerThroughRecovery_consumesRecoverySignerWhenNextRecoverySignerIsZero() public {
        ...
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.InvalidNewRecoverySigner.selector));
        assertFalse(_account(A1).isPaused(), "account should be unpaused");
    ...
    function test_rotateAuthorizedSignerThroughRecovery_rejectsUsedNextRecoverySignerAndConsumesRecoverySigner() public {
        ...
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.SignerAlreadyConsumedOrReserved.selector, R2));
        assertFalse(_account(A1).isPaused(), "account should be unpaused");
        assertEq(_account(A1).currentAuthorizedSigner(), A3, "authorized signer should rotate");
        assertFalse(_account(A1).isActiveRecoverySigner(R1), "R1 should be consumed");
    ...
    function test_rotateAuthorizedSignerThroughRecovery_rejectsSameAuthorizedAndRecoverySignerAndConsumesRecoverySigner() public {
        ...
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.SignerAlreadyConsumedOrReserved.selector, A3));
        assertFalse(_account(A1).isPaused(), "account should be unpaused");
        assertEq(_account(A1).currentAuthorizedSigner(), A3, "authorized signer should rotate");
        assertTrue(_account(A1).isConsumedOrReservedSigner(A3), "A3 should be reserved after failed recovery");
        assertFalse(_account(A1).isActiveRecoverySigner(R1), "R1 should be consumed");
    ...
    function test_signedRecovery_unpausesPausedAccountAndRotatesRecoverySigner() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = _recoveryOperation(A3, R3);
    ...
    function test_signedRecovery_canRotateEvenWhenNotPaused() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = _recoveryOperation(A3);
        bytes memory signature = _signRecoveryOperation(A1, R1_PK, recoveryOperation);
    ...
    function test_signedRecovery_consumesRecoverySignerWhenOperationExpired() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = EphemeralKeyAccount.RecoveryOperation({
            nextAuthorizedSigner: A3,
        ...
        assertEq(result, abi.encodeWithSelector(EphemeralKeyAccount.ExpiredOperation.selector, recoveryOperation.deadline));
        assertTrue(_account(A1).isPaused(), "account should remain paused");
        assertEq(_account(A1).currentAuthorizedSigner(), A2, "authorized signer should remain A2");
    ...
    function test_signedRecovery_consumesRecoverySignerEvenWhenNextSignerIsInvalid() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = _recoveryOperation(address(0));
        bytes memory signature = _signRecoveryOperation(A1, R1_PK, recoveryOperation);
    ...
    function test_signedRecovery_consumesRecoverySignerWhenNextRecoverySignerIsZero() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = _recoveryOperation(A3, address(0));
        bytes memory signature = _signRecoveryOperation(A1, R1_PK, recoveryOperation);
    ...
    function test_signedRecovery_rejectsUsedNextAuthorizedSignerAndConsumesRecoverySigner() public {
        ...
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation = _recoveryOperation(A2, R3);
        bytes memory signature = _signRecoveryOperation(A1, R1_PK, recoveryOperation);
    ...
    function test_signedRecovery_rejectsSignatureBoundToAnotherDelegatedAccount() public {
        ...
        vm.prank(relayer);
        vm.expectRevert(
            abi.encodeWithSelector(EphemeralKeyAccount.RecoverySignerNotActive.selector, recoveredAgainstA1)
        );
    ...
    function _signOperation(
        ...
        EphemeralKeyAccount.Operation memory operation
    )
        internal
        view
    ...
    function _signRecoveryOperation(
        address payable accountAddress,
        uint256 signerPrivateKey,
        EphemeralKeyAccount.RecoveryOperation memory recoveryOperation
    )
        internal
        view
        returns (bytes memory)
    ...
    function _operation(
        ...
        internal
        view
        returns (EphemeralKeyAccount.Operation memory)
    {
        return EphemeralKeyAccount.Operation({
            target: target_,
            value: value_,
            data: data_,
    ...
    function _recoveryOperation(address nextAuthorizedSigner)
        internal
        view
        returns (EphemeralKeyAccount.RecoveryOperation memory)
    {
    ...
    function _recoveryOperation(address nextAuthorizedSigner, address nextRecoverySigner)
        ...
        returns (EphemeralKeyAccount.RecoveryOperation memory)
    {
        return EphemeralKeyAccount.RecoveryOperation({
    ...
    function _account(address payable accountAddress) internal pure returns (EphemeralKeyAccount) {
        return EphemeralKeyAccount(accountAddress);
    }
