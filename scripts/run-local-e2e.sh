...
WALLET_INSTALL_LOG="$E2E_DIR/wallet-install.log"
WALLET_TYPECHECK_LOG="$E2E_DIR/wallet-typecheck.log"
WALLET_TEST_LOG="$E2E_DIR/wallet-test.log"
DEPLOY_IMPLEMENTATION_LOG="$E2E_DIR/deploy-implementation.log"
INITIALIZE_LOG="$E2E_DIR/initialize.log"
DEPLOY_TARGET_LOG="$E2E_DIR/deploy-target.log"
PREPARE_INIT_LOG="$E2E_DIR/prepare-init.log"
STATE_INIT_LOG="$E2E_DIR/state-init.log"
SYNC_LOG="$E2E_DIR/sync.log"
SET_NUMBER_LOG="$E2E_DIR/set-number.log"
TARGET_REVERT_LOG="$E2E_DIR/target-revert.log"
EXPIRED_LOG="$E2E_DIR/expired.log"
INVALID_NEXT_AUTH_LOG="$E2E_DIR/invalid-next-auth.log"
RECOVERY_LOG="$E2E_DIR/recovery.log"
POST_RECOVERY_SET_NUMBER_LOG="$E2E_DIR/post-recovery-set-number.log"
