...
import { EphemeralWallet } from "../src/core/EphemeralWallet.js";
import type { AccountClientLike, WalletStateStore } from "../src/core/types.js";
...
import type { Operation, RecoveryOperation } from "../src/account/types.js";
import type { SyncResult } from "../src/account/sync.js";
...
class FakeAccountClient implements AccountClientLike {
...
describe("EphemeralWallet core SDK", () => {
