...
import { ephemeralKeyAccountAbi } from "./abi.js";
import {
  reconcileLocalState,
  type OnchainAccountSnapshot,
  type SyncResult,
} from "./sync.js";
import type { LocalWalletState } from "./state.js";
import type { Operation, RecoveryOperation } from "./types.js";

export type EphemeralAccountClientConfig = {
  rpcUrl: string;
  chainId: number;
...
/**
 * Thin RPC adapter around EphemeralKeyAccount.
 *
 ...
 */
export class EphemeralAccountClient {
  ...
  constructor(config: EphemeralAccountClientConfig) {
