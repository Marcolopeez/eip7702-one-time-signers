...
import type { Operation, RecoveryOperation } from "../account/types.js";
...
export class EphemeralWallet {
  ...
  readonly client: AccountClientLike;

  constructor(config: EphemeralWalletConfig) {
